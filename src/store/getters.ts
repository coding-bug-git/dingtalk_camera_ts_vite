// // import type { Getters, GettersState } from '@/typings/vuex'
//
...
//   nickName: (state: GettersState) => state.user?.nickName,
...
//   permissionRoutes: (state: GettersState) => state.permission?.routes,
